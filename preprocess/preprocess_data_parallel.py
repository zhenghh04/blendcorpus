...
def get_args():
    ...
    group.add_argument('--input-dir', type=str, required=True,
...
def main():
    ...
    if args.partitions == 1:
        ...
        for in_file_name in in_file_names:
            ...
            # output_prefix is a directory; join with the base name of the file (no extension)
            output_prefix = get_output_prefix(args.input_dir, in_file_name, args.output_dir)
            level = "document"
            if args.split_sentences:
                level = "sentence"
